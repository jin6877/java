              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                   ...
                   <form action="${context}/member/loginProc" method="post">
                    <div class="form-group">
                      <input type="email" class="form-control form-control-user" id="exampleInputEmail" name="email" aria-describedby="emailHelp" placeholder="Email을 입력하시오">
                    </div>
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" id="exampleInputPassword" name="pw" placeholder="Password를 입력하시오.">
                    </div>
                    <div class="form-group">
                    ...
                    <button class="btn btn-success btn-user btn-block" id="login">login</button>
                   
                    <c:if test="${log eq 'logfail'}">
                    	<script>
                    		alert("이메일과 비밀번호를 확인하시오.");
                    	</script>
                    </c:if>
                    <hr>
