		...
		<div id="content-wrapper" class="d-flex flex-column">
			<div id="content">
				...
				<div class="container-fluid">
					<h1 class="h3 mb-2 text-gray-800">연애툰</h1>
					<p class="mb-4">글쓰기</p>
					
					<div class="card shadow mb-4">
						<form action="${context}/Picture_diary/love/love_lifeInsert" method="post" id="fileUploadForm" enctype="multipart/form-data">
...
<%-- 								<img id="imgpath" src="/resources/${imgpath}" width="100%" />  --%>
							...
							<div class="text-right justify-content-end" style="padding: 10px;">
										...
										<a href="${context}/Picture_diary/love_life" class="btn btn-success btn-icon-split "> 
